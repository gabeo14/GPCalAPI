...
namespace MotoCalAPI.Migrations
{
    ...
    [Migration("20181108212205_AddedMotoGpAndOneIndy")]
    partial class AddedMotoGpAndOneIndy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MotoCalAPI.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MotoCalAPI.Models.Event", b =>
                {
                    b.HasOne("MotoCalAPI.Models.Series", "Series")
                        .WithMany("Events")
